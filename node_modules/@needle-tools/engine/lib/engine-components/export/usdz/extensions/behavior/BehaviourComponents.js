...
export class PlayAnimationOnClick extends Behaviour {
    ...
    afterCreateDocument(ext, context) {
        ...
        document.traverse(model => {
            if (model.uuid === this.target?.uuid) {
                const sequence = PlayAnimationOnClick.getActionForSequences(model, this.animationSequence, this.animationLoopAfterSequence, this.randomOffsetNormalized);
    ...
    static getActionForSequences(model, animationSequence, animationLoopAfterSequence, randomOffsetNormalized) {
